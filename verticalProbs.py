...
def main():
    path = "./levels_testing/vertical/*.txt"
    path1 = "./levels_testing/vertical1/*.txt"
    # change to trainVertial1 to get the difference after adding direction node
    markov = trainVertical(path)
    markov1 = trainVertical(path1)
    ...
    print(result)
    print(result1)
    # vertical: 0.8671489073341843
    # vertical1: 0.14583686357782547
    print(difference)
